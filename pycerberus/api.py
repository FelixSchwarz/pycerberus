...
class BaseValidator(object):
    ...
    def error(self, key, value, context):
        msg = self.message_for_key(key, context)
        raise InvalidDataError(msg, value, key, context)
...
class Validator(BaseValidator):
    ...
    def process(self, value, context=None):
        ...
        external context (e.g. current user). This context object is passed to 
        all other methods which can be implemented by subclasses. If you don't 
        provide any context, an emtpy dict will be used instead.
